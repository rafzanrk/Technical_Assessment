...
<head>
    ...
    <div class="h8der">
        ...
        <!-- header web logo -->
        <div>
            <img class="logoWeb" src="md/icon.png" alt="GRA Wiz" title="We Got'Em!"/>
        </div>
    ...
    <div class="contactBG"><center>
        <h1> Get in Touch 
            ...
            <div style="font-size: 23px; margin-top: 50px">
                ...
                <b style="margin-left: 10%;"> &#9993; <span class="cont8" id="inputTxt2" title="Click to copy email address">info@gns.net</span>
