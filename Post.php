...
<body>
    ...
    <div class="fadeIn-BG">  
        <h1> FIND OTHERS AND MAYBE FIND YOUR FRIENDS! </h1>
            ...
            <h2 style="padding-top: 25px; margin-bottom: -7.5px; letter-spacing: 3px;"> CREATE </h2>

        <!-- sign up section -->
        <div class="SUp-Section" style="margin-top: 50px; margin-bottom: 30px;">
                
                <!-- username text input -->
                    <img src="md/accn.png" alt="ID" title="Kindly enter your ID"/>
                <label for="ID">ID</label>
                <input type="text" id="ID" name="ID" placeholder="ID" required>

                <!-- password text input -->
                <br><img src="md/passw.png" alt="Name" title="Whats Your Name?"/>
                <input type="text" id ="Name" name="Name" placeholder="Name" required>

                <!-- email text input -->
                <br><img src="md/mail.webp" alt="Email" title="Enter your email here"/>
                <label for="email">Email</label>
                <input type="text" id="Email" name="Email" placeholder="Email" required>

                <br><img src="md/accn.png" alt="Gender" title="Gender"/>
                <label for="gender">Gender</label>
                <input type="text" id="Gender" name="Gender" placeholder="Gender" required>

                <br><img src="md/accn.png" alt="status" title="Enter Status"/>
        ...
        <div style="padding: 25px;">
            <!-- API submit button -->
            <button type="submit" name="get" class="signUp" onclick="window.location.href='http://localhost/Technical_Assessment/Get.php'">Look At The Users So Far</button>
            <button type="submit" name="post" id="options" class="signUp"onclick="window.location.href='http://localhost/Technical_Assessment/Post.php'">Create New Users</button>
        ...
        <script>
            ...
            // send POST request
            fetch('https://gorest.co.in/public/v1/users', options)
                .then(res => res.json())
