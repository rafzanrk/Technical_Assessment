...
<?php
    ...
    { ?>
        ...
        <form class="signBox" action="" method="post">
            ...
            <span class="logOpt" style="color: rgba(255, 255, 255, 0.75);"> Have account? <input type="button" onclick="getElementById('LB.js').style.display='block'" value="Login" style="color: #ffc400; font-size: 16px;"> instead.</span>
        </form> </center>
